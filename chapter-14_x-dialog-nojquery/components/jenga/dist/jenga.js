...
var jenga = (function (global) {
    ...
    function isPosAndHasZindex(el) {
        return (el.nodeType === 11) || (el.style.position && el.style.position !== 'static') && (el.style.zIndex !== 'auto' &&
    ...
    function modifyZindex(el, increment) {
        ...
        stackingCtxEl = stackingCtxEl.tagName === 'HTML' ? document.body : stackingCtxEl;
